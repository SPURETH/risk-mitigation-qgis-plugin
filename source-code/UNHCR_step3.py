...
class Step3():
    """This class contains all functions needed to perform step 3."""
    ...
    def _setupMap(self):
        ...
        lyrriverine = QgsProject.instance().mapLayersByName("RiverineFlood")[0]
    ...
    def adjustFlood(self, returnPeriod, intensity):
        ...
        self.selectedArea = QgsVectorLayer('Polygon?crs=' + self.floodLayer.crs().authid(), "temp", 'memory') # 'Polygon?crs=epsg:4326'
    ...
    def _feature_added(self):
        ...
        if not self.floodLayer.selectedFeatures():      # if no feature is selcted
            ...
            new_feature['RepeatYear'] = self.returnPeriod  # Set the risk level for the new feature
            ...
            for feature in self.floodLayer.selectedFeatures():
                ...
                if feature.geometry().intersects(drawnGeometry):
                    ...
                    org_repeatYear = feature['RepeatYear']
                    ...
                    if not remaining_geometry.isEmpty():
                        ...
                        new_feature['RepeatYear'] = org_repeatYear  # Set the risk level for the new feature
                ...
                feature['RepeatYear'] = self.returnPeriod
